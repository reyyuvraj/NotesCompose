...
import com.example.notescompose.featurenote.domain.usecase.NoteUseCases
...
// job of view-model is not business logic in clean architecture as it is in plain mvvm
// instead it has to make use of the use cases. Business logic is in the use cases. view-model takes
// the result of the use cases
